...
export default function Hero(): JSX.Element {
  return (
    <div className='w-full h-screen px-12 py-4  mx-auto'>
      <div className='grid grid-cols-1 md:grid-cols-8 gap-4'>
        ...
        <div className='col-start-2 col-span-7 bg-chow-black w-full rounded-3xl py-6 space-y-12'>
          ...
          <div className='flex flex-col justify-center items-center py-14 space-y-8'>
            ...
            <h1 className='text-7xl font-semibold text-chow-white'>Find chow, <span className='text-chow-green font-courgette'>Asap!</span></h1>
            ...
            <div className='py-4 flex items-center flex-col md:flex-row gap-5 w-1/2'>
              <input type="email" placeholder='Enter your email' className='rounded-md p-4 w-full' />
              <button className='rounded-full py-4 w-1/2 text-chow-white bg-chow-green border-2 border-chow-white  hover:opacity-50'>JOIN WAITLIST</button>
            </div>
          </div>
